...
/**
 * Server renderer for the Interactivity API chat block variant.
 */
final class InteractivityRenderer
{
    ...
    public function render(array $attributes = []): string
    {
        ...
        return sprintf(
            '<div class="wpna-interactivity-chat" data-wpna-interactivity-chat="1" data-placeholder="%s" data-system-prompt-override="%s" data-system-prompt-mode="%s" data-max-height="%s" data-enabled-tools="%s" data-ui-config="%s" data-model="%s" data-rest-nonce="%s" data-wp-interactive="wp-native-agent/chat"></div>',
