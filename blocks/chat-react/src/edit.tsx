...
function Edit( { attributes, setAttributes }: EditProps ) {
	...
	const setStyleValue = ( key: StyleKey, value: string ) => {
		setAttributes( { [ key ]: value } as Partial< ChatReactAttributes > );
	};
	...
	return (
		<>
			<InspectorControls>
				<PanelBody title="Chat UI" initialOpen={ true }>
					...
					<SelectControl
						...
						onChange={ ( value ) =>
							setAttributes( {
								theme: value as ChatReactAttributes[ 'theme' ],
							} )
						}
					/>
					<ToggleControl
			...
			<div { ...blockProps }>
				<div className="wpclaw-chat-placeholder">WPClaw React Chat</div>
			</div>
		</>
	);
}
